...
{
    this->moder.cover(static_cast<decltype(lckr)::value_type>(0b11) << pin * 2,
...
{
    this->otyper.cover(static_cast<decltype(lckr)::value_type>(0b1) << pin,
...
{
    this->speedr.cover(static_cast<decltype(lckr)::value_type>(0b11) << pin * 2,
                       static_cast<decltype(lckr)::value_type>(val) << pin * 2);
}

[[maybe_unused]] io_attr::speed_t io_base::get_speed(pin_t pin)
{
    return static_cast<io_attr::speed_t>((this->speedr.read() >> pin * 2) &
                                         0b11);
}
void io_base::set_pupd(pin_t pin, io_attr::pupd_t val)
{
    this->pupdr.cover(static_cast<decltype(lckr)::value_type>(0b11) << pin * 2,
                      static_cast<decltype(lckr)::value_type>(val) << pin * 2);
}
...
{
    this->lckr.cover((static_cast<decltype(lckr)::value_type>(0b1) << 16) |
